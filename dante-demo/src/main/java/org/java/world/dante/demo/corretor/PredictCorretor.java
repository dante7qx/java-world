package org.java.world.dante.demo.corretor;
...
public class PredictCorretor {
	...
	@Test
	public void predictCorretor() throws DCSSecException {
		String uri = "/mlmodel/predict/corretor";
		...
		requestBody.put("input_data", new String[] {"中文语言因该纠错", "我们是21实际的人才"});
