...
public class LunarCalendar {
	 ...
	 * @return
	 */
	public static String getLastLunarDate(int year, int month, int monthDay) {
		int [] curNlArr = LunarCalendar.solarToLunar(year, month, monthDay);
		int lastYear = curNlArr[0] - 1;
		boolean leap = LunarCalendar.leapMonth(lastYear) > 0 ? true : false;
		int[] lastDateArr = LunarCalendar.lunarToSolar(lastYear, curNlArr[1], curNlArr[2], leap);
		return lastDateArr[0] + "-" + lastDateArr[1] + "-" + lastDateArr[2];
	}
	 ...
	 * @return
	 */
	public static String getLastLunarDate(String curDate) {
		String[] dateArr = curDate.split("-");
		return getLastLunarDate(Integer.parseInt(dateArr[0]), Integer.parseInt(dateArr[1]), Integer.parseInt(dateArr[2]));
	}
