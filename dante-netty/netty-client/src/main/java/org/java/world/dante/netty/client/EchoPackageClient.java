...
import org.java.world.dante.netty.handler.EchoClientPackageHandler;
...
public class EchoPackageClient {
			...
			client.group(clientGroup)
				...
				.handler(new ChannelInitializer<SocketChannel>() {
					...
					protected void initChannel(SocketChannel socketChannel) throws Exception {
						...
						socketChannel.pipeline().addLast(new EchoClientPackageHandler());
					}
				})
