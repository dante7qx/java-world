...
import org.java.world.dante.netty.handler.EchoClientMsgPackSerializableHandler;
...
public class EchoMsgPackSerializableClient {
			...
			client.group(clientGroup)
				...
				.handler(new ChannelInitializer<SocketChannel>() {
					...
					protected void initChannel(SocketChannel socketChannel) throws Exception {
						...
						socketChannel.pipeline().addLast(new EchoClientMsgPackSerializableHandler());
					}
				})
