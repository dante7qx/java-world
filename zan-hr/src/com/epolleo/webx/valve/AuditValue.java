...
public class AuditValue extends AbstractValve implements ProductionModeAware {
    ...
    public void invoke(PipelineContext pipelineContext) throws Exception {
        try {
            ...
            try {
                ...
                if (s instanceof Set<?>) {
                    Set<?> set = (Set<?>) s;
                    Set<?> ps = new LinkedHashSet<Object>(request
            ...
            boolean enableAudit = !"false".equals(request.getSession()
                .getServletContext().getAttribute("bp.enableAudit"));
    ...
    private void doAudit() {
        ...
        log.setLogId(seqService.getNewId(IdKind.AuditLogId));
        ...
        log.setOperationTime(DateUtils.getCurrentDate());
